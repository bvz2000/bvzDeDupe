...
class ByParent(object):
    """
    A class to store afile objects with a specific parent directory name.
    """
    ...
    def __init__(self,
                 name=None):
        """
        :param name: The parent directory name shared by all the files stored in this instance. If None, the name will
               be set to "" and will have to be set directly later. Defaults to None.
        """
